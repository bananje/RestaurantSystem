...
namespace LuckyFoodSystem.Identity.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    private readonly SignInManager<LuckyFoodUser> _signInManager;
    ...
    public Callback(
        ...
        UserManager<LuckyFoodUser> userManager,
        SignInManager<LuckyFoodUser> signInManager)
    {
    ...
    private async Task<LuckyFoodUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
        var sub = Guid.NewGuid().ToString();
            
        var user = new LuckyFoodUser
        {
            Id = sub,
