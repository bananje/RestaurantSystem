...
using LuckyFoodRestaurantSystem.OrdersDelivery.Infrastructure.Common;
...
public class SeedConfiguration
{
    ...
    public static void SeedDataAsync(IDocumentStore documentStore)
    {
        ...
        var order = new Order(customerId, address); // Дополните инициализацию OrderState, если необходимо
        ...
        // session.Events.StartStream(typeof(OrderState), orderId.Value, SerializeEvent(orderConfirmedEvent));
