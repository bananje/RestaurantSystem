...
namespace LuckyFoodSystem.Orders.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class InitalMigration : Migration
    {
        ...
        { customerIds[4], "Eve", "Q.", "Wilson", "eve.wilson@example.com", "8888888888", 4, "202 Birch St", 1L }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
        { productIds[0], "Product 1", "Description 1", "http://example.com/product1.jpg", "Available", "Short Description 1", 100m, 10m, 5m, 15m, 90m, 1.0, "kg" },
        { productIds[1], "Product 2", "Description 2", "http://example.com/product2.jpg", "Available", "Short Description 2", 200m, 20m, 10m, 25m, 180m, 1.5, "kg" },
        { productIds[2], "Product 3", "Description 3", "http://example.com/product3.jpg", "Out of Stock", "Short Description 3", 300m, 30m, 15m, 35m, 270m, 2.0, "kg" },
        { productIds[3], "Product 4", "Description 4", "http://example.com/product4.jpg", "Available", "Short Description 4", 400m, 40m, 20m, 45m, 360m, 2.5, "kg" },
        { productIds[4], "Product 5", "Description 5", "http://example.com/product5.jpg", "Available", "Short Description 5", 500m, 50m, 25m, 55m, 450m, 3.0, "kg" }
                });
